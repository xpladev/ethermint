...
import (
	...
	"github.com/xpladev/ethermint/x/evm/migrations/v4/evm/params"
	"github.com/xpladev/ethermint/x/evm/types"
)

// EthereumConfig returns an Ethereum ChainConfig for EVM state transitions.
// All the negative or nil values are converted to nil
func (cc V4ChainConfig) EthereumConfig(chainID *big.Int) *params.V4ChainConfig {
	return &params.V4ChainConfig{
		ChainID:                 chainID,
