...
var (
	pattern_Query_TotalSupply_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"ethermint", "testerc", "v1", "total_supply"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_BalanceOf_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"ethermint", "testerc", "v1", "balance_of"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Allowance_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"ethermint", "testerc", "v1", "allowance"}, "", runtime.AssumeColonVerbOpt(false)))
)
