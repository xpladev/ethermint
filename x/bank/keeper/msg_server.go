...
// SetSendEnabled implements types.MsgServer.
// Subtle: this method shadows the method (Keeper).SetSendEnabled of msgServer.Keeper.
// Copyed from cosmos-sdk/x/bank/keeper/msg_server.go
func (k msgServer) SetSendEnabled(goCtx context.Context, msg *banktypes.MsgSetSendEnabled) (*banktypes.MsgSetSendEnabledResponse, error) {
...
// Copyed from cosmos-sdk/x/bank/keeper/msg_server.go
func (k msgServer) UpdateParams(goCtx context.Context, req *banktypes.MsgUpdateParams) (*banktypes.MsgUpdateParamsResponse, error) {
