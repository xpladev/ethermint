...
func NewTestChain(t testing.TB, coord *ibcgotesting.Coordinator, chainID string) *ibcgotesting.TestChain {
	...
	amount := sdk.TokensFromConsensusPower(1, etherminttypes.PowerReduction)

	balance := banktypes.Balance{
		Address: acc.GetAddress().String(),
		Coins:   sdk.NewCoins(sdk.NewCoin(testutil.BaseDenom, amount)),
	}
