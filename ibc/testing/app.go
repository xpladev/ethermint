...
var DefaultTestingAppInit func() (ibcgotesting.TestingApp, ethermintapp.GenesisState) = ethermintapp.SetupTestingApp

// SetupWithGenesisValSet initializes a new SimApp with a validator set and genesis accounts
// that also act as delegators. For simplicity, each validator is bonded with a delegation
// of one consensus engine unit (10^6) in the default token of the simapp from first genesis
// account. A Nop logger is set in SimApp.
func SetupWithGenesisValSet(t testing.TB, valSet *tmtypes.ValidatorSet, genAccs []authtypes.GenesisAccount, chainID string, balances ...banktypes.Balance) ibcgotesting.TestingApp {
	...
	// set bond demon to be attophoton
	...
	for _, b := range balances {
		...
		totalSupply = totalSupply.Add(b.Coins.Add(sdk.NewCoin(evmtypes.DefaultEVMDenom, bondAmt))...)
	}
	...
	_, err = app.InitChain(
		&abci.RequestInitChain{
			...
			ConsensusParams: ethermintapp.DefaultConsensusParams,
